...
**Document-oriented databases** stores data as self-contained units of data with a flexible structure / schema. This is why JSON is often used to represent documents in document databases.
